...
export const HeartIcon = forwardRef<SVGSVGElement, IconInterface & { variant?: 'variant1' | 'variant2' }>(
    ({ iconColor = "currentColor", size = "24px", variant = "variant1" }, ref) => {
        // Local state to toggle the variant on click
        const [currentVariant, setCurrentVariant] = useState(variant);

        // Function to toggle between variants
        const toggleVariant = () => {
            setCurrentVariant(prevVariant => (prevVariant === 'variant1' ? 'variant2' : 'variant1'));
        };
        ...
        const heartColor = colorMap[currentVariant] || iconColor;
        ...
        return (
            <svg
                ...
                onClick={toggleVariant} // Toggle variant on click
            >
