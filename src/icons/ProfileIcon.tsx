...
// @ts-ignore
export const ProfileIcon = forwardRef<SVGSVGElement, IconInterface>(({ iconColor = "currentColor", size = "24px", onClick }, ref) => {
    ...
    return (
        <svg
            ...
            onClick={onClick} // Makes it clickable if an onClick handler is passed
        >
            <path
